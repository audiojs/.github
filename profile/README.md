...
Every algorithm is its own package — 280+ atoms, 35 families, one engine:
...
| **Targets** | ✓ [wam](https://github.com/audiojs/wam) AudioWorklet → ◐ [jz](https://github.com/dy/jz) WASM · native → ○ [compile](https://github.com/audiojs/compile) VST3 · CLAP · AU · LV2<br>◐ [host](https://github.com/audiojs/host) loads native plugins back into JS |
...
<p>
  ...
  <img src="https://img.shields.io/badge/biquads-1e--9%20vs%20reference-444" alt="biquads within 1e-9 of reference design">
  <img src="https://img.shields.io/badge/FM-Bessel%20tables-444" alt="FM sidebands verified against Bessel tables">
  <img src="https://img.shields.io/badge/resampling-alias%20floors-444" alt="resamplers verified by measured alias floors">
  <img src="https://img.shields.io/badge/MIR-MIREX%20sets-444" alt="MIR verified on MIREX-class evaluation sets">
  <img src="https://img.shields.io/badge/measurement-Farina%20ESS-444" alt="measurement verified by Farina ESS round-trips">
</p>
